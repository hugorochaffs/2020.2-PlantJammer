...
| Identificador (ID) | Descrição | Prioridade (MosCoW) | Tipo |
| :----------------: | :-------: | :-----------------: | :--: |
...
|  | Ter a opção de fazer login através do Facebook, Google | Would | Requisito Funcional |
|  | Ter a opção de fazer login usando email/username e senha | Must | Requisito Funcional |
|  | Ter a opção de realizar cadastro através do Facebook, Google | Would | Requisito Funcional |
...
|  | As receitas devem ter associada um vídeo preparo | Could | Requisito Funcional |
